...
def solution_C5():
    ...
    model = tf.keras.models.Sequential([
        ...
        # YOUR CODE HERE
        tf.keras.layers.Dense(30, input_shape=[N_PAST, N_FEATURES], activation='relu'),
    ...
    callback = myCallback()
    model.fit(train_set, epochs=30, validation_data=valid_set, callbacks=callback, verbose=1)
